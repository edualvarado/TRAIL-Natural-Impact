...
public class ExportPressureMap : RunAbleThread
{
    // Property with 1D array  
    public byte[] PressureBytes { get; set; }
        ...
        using (RequestSocket client = new RequestSocket())
        {
            ...
            for (int i = 0; i < 1000000 && Running; i++)
            {
                ...
                */
                ...
                client.SendFrame(TerrainDeformationMaster.PressureMapBytes);
                ...
                if (gotMessage)
                {
                    PressureBytes = message;
                    Debug.Log("Received Pressure:" + message);
                }
            }
        }
