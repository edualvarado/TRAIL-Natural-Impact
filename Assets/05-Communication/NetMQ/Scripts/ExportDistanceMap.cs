...
/// </summary>
public class ExportDistanceMap : RunAbleThread
{
    public byte[] DistanceBytes { get; set; }
        ...
        using (RequestSocket client = new RequestSocket())
        {
            ...
            for (int i = 0; i < 1000000 && Running; i++)
            {
                ...
                */
                ...
                client.SendFrame(DistanceTracker.DistanceBytes);
                ...
                if (gotMessage)
                {
                    DistanceBytes = message;
                    Debug.Log("Received Distance " + message);
                }
            }
        }
