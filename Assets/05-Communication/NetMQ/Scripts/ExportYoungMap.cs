...
/// </summary>
public class ExportYoungMap : RunAbleThread
{
    // Property with 1D array  
    public byte[] YoungBytes { get; set; }
    ...
    protected override void Run()
    {
        ...
        using (RequestSocket client = new RequestSocket())
        {
            ...
            for (int i = 0; i < 1000000 && Running; i++) // Original: 10000
            {
                ...
                */
                ...
                client.SendFrame(TerrainDeformationMaster.YoungMapBytes);
                ...
                {
                    YoungBytes = message;
                    Debug.Log("Received Young:" + message);
                }
            }
        }
